...
export default function MenuScanPage() {
  ...
  const handleScanSuccess = (result: any) => {
    ...
    // Generar una recompensa basada en el QR escaneado
    const rewards = [
      "¡Felicidades! Has ganado $1.000 en tu billetera.",
      "¡Enhorabuena! Has desbloqueado una insignia nueva.",
      "¡Genial! Has ganado 10 puntos para tu colección de café."
    ];
      ...
      >
        ...
        <Paper sx={{ p: 3, mb: 3, border: '2px solid #ddd', boxShadow: 'none' }}>
          ...
          <Typography variant="body2" paragraph>
            1. Encuentra un código QR en el menú de CasaMia o en la tienda.
          </Typography>
          <Typography variant="body2" paragraph>
            2. Escanea el código con la cámara de tu dispositivo.
          </Typography>
          <Typography variant="body2" paragraph>
            3. Recibe recompensas inmediatas como saldo en tu billetera, insignias exclusivas o puntos para completar colecciones.
          </Typography>
          <Typography variant="body2" paragraph>
            4. ¡Vuelve cada día para nuevas sorpresas y recompensas!
          </Typography>
        </Paper>
          ...
          {!scanned ? (
            <>
              <Typography variant="h6" sx={{ mb: 2 }}>
                Escanea el código QR del menú para obtener recompensas
              </Typography>
              ...
              >
                {showScanner ? (
                  ...
                  >
                    <CameraAlt sx={{ fontSize: 60, color: '#aaa', mb: 2 }} />
              ...
              <Typography variant="body2" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5 }}>
                ...
                {scanError ? 
                  ...
                  "Tu ubicación será registrada con el escaneo"}
              </Typography>
            </>
          ) : (
            <Box sx={{ py: 3 }}>
