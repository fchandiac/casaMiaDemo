...
export default function ProfilePage() {
  const attributes = [
    { name: 'id', type: 'string', description: 'Identificador único del perfil' },
    { name: 'userId', type: 'string', description: 'ID del usuario propietario del perfil' },
    { name: 'userSegmentOptions', type: 'JSON', description: 'Conjunto de opciones de segmentación del usuario' }
  ];

  const relationships = [
    { entity: 'User', type: '1:1', description: 'Un perfil pertenece a un usuario específico' },
    { entity: 'UserSegmentOption', type: '1:N', description: 'Un perfil puede tener múltiples opciones de segmentación' },
    { entity: 'Segment', type: 'N:M', description: 'Un perfil puede pertenecer a múltiples segmentos' }
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography variant="body1" paragraph sx={{ mb: 4 }}>
        Compuesto por múltiples opciones de segmentación. Define grupos con listas, casillas de verificación o valores numéricos.
      </Typography>
